...
export interface Delta2MaxState {
  ...
  /* ------------------------------------------------------- *\
   *  bms_slave_bmsSlaveStatus.* - External battery          *
  \* ------------------------------------------------------- */
  ...
  /* ------------------------------------------------------- *\
   *  bms_slave_bmsSlaveStatus_1.* - External battery pack 1 *
  \* ------------------------------------------------------- */
  ...
  /* ------------------------------------------------------- *\
   *  bms_slave_bmsSlaveStatus_2.* - External battery pack 2 *
  \* ------------------------------------------------------- */
  ...
  /* ------------------------------------------------------- *\
   *  bms_slave_bmsSlaveInfo_1.* - External battery pack 1   *
  \* ------------------------------------------------------- */
